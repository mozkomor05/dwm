...
static const unsigned int smartgaps =
...
// Font:size=10:style=bold:antialias=true:autohint=true" };
static const char *fonts[] = {
    "JetBrainsMono NF:size=10:antialias=true:autohint=true",
        ...
        RULE(.wintype = WTYPE "UTILITY", .isfloating = 1)
            RULE(.wintype = WTYPE "TOOLBAR", .isfloating = 1)
                RULE(.wintype = WTYPE "SPLASH", .isfloating = 1)
                    RULE(.class = "kitty", .iscentered = 1, .isterminal = 1)
...
static const Key keys[] = {
    ...
    {MODKEY, XK_d, spawn,
     SHCMD(
         "~/.config/rofi/launchers/launcher/launcher.sh")}, /* rofi launcher */
    {MODKEY, XK_v, spawn,
     SHCMD("~/.config/rofi/launchers/greenclip/launcher.sh")}, /* rofi clipboard
                                                                */

    {0, XK_Print, spawn, {.v = prtscrcmd}},
    {0, XF86XK_AudioMute, spawn,
     SHCMD("pamixer -t; kill -36 $(pidof dwmblocks)")},
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("pamixer --allow-boost -i 3; kill -36 $(pidof dwmblocks)")},
    {0, XF86XK_AudioLowerVolume, spawn,
     SHCMD("pamixer --allow-boost -d 3; kill -36 $(pidof dwmblocks)")},
    ...
    {MODKEY, XK_space, spawn,
     SHCMD("xkb-switch -n; kill -37 $(pidof dwmblocks)")},
};
